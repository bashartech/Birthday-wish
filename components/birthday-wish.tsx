...
useEffect(()=>{
    if(candlesLit === totalCandles && balloonsPoppedCount === totalBallons){
      ...
      >
        <Card className="mx-auto overflow-hidden transition-all duration-300 ease-in-out hover:shadow-xl border-2 border-black">
          <CardHeader className="text-center">
            ...
            <CardDescription className="text-2xl font-semibold text-gray-600">M.Bashar Sheikh</CardDescription>
            <p className="text-lg text-gray-500">November 14th</p>
          </CardHeader>
